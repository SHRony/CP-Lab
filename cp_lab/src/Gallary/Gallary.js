            ...
            <div className='Gallary' id = "Glr">
                <div className='top'>
                        ...
                        <div className='top-right'>
                                <div className='top-right-left'>
                                        <div className='sec-4 sec'><Image src ={lab3}/></div>
                                        <div className='sec-5 sec'></div>
                                </div>
                                <div className='top-right-right'>
                                        <div className='sec-6 sec'></div>
                                        <div className='sec-7 sec'><Image src ={lab3}/></div>
                                </div>
                        </div>
                </div>
                ...
                <div className='bottom'>
                        <div className='bottom-left'>
                                <div className='bottom-left-left sec-8 sec' ><Image src ={lab2}/></div>
                                <div className='bottom-left-right sec-9 sec'><Image src ={lab2}/></div>
                        </div>
